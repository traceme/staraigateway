	...
	<table class="w-full">
		<thead>
			<tr class="border-b border-zinc-800 bg-zinc-900/80">
				...
				<th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-zinc-500">Role</th>
				<th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-zinc-500">Joined</th>
				<th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-zinc-500">Usage</th>
				{#if isAdmin}
...
{#if isAdmin && pendingInvitations.length > 0}
	<div class="mt-6">
		<h3 class="mb-3 text-sm font-semibold text-zinc-300">Pending Invitations</h3>
		<div class="overflow-hidden rounded-lg border border-zinc-800 bg-zinc-900">
			<table class="w-full">
				<thead>
					<tr class="border-b border-zinc-800 bg-zinc-900/80">
						<th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-zinc-500">Email</th>
						<th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-zinc-500">Role</th>
						<th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-zinc-500">Invited By</th>
						<th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-zinc-500">Sent</th>
						<th class="px-4 py-3 text-right text-xs font-medium uppercase tracking-wider text-zinc-500"></th>
					</tr>
				</thead>
				<tbody>
