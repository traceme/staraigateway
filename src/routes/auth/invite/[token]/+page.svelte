	...
	<div class="w-full max-w-md">
		{#if !data.valid}
			<div class="rounded-lg border border-zinc-800 bg-zinc-900 p-8 text-center">
				...
				<h2 class="mt-4 text-lg font-semibold text-zinc-100">This invitation is no longer valid</h2>
				<p class="mt-2 text-sm text-zinc-400">
					The invitation may have expired or already been used. Please ask the organization admin to
