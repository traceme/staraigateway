...
- [ ] **DEBT-03**: Invitation acceptance wrapped in DB transaction
...
- [ ] **DEBT-06**: Session cleanup cron (prune expired sessions)
- [ ] **DEBT-07**: DB connection pool explicitly configured (pool size, timeouts)
