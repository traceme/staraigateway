...
Plans:
- [x] 12-01-PLAN.md — i18n infrastructure: svelte-i18n setup, translation JSON files, DB migration, language switcher, API endpoint, tests
- [x] 12-02-PLAN.md — Wire $t() into all dashboard components and page routes, migrate server errors to translatable keys
...
|-------|-----------|----------------|--------|-----------|
| 12. Dashboard Internationalization | v1.2 | 2/2 | Complete | 2026-03-18 |
